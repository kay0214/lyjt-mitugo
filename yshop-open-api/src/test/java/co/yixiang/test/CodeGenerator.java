...
public class CodeGenerator {
    ...
    // ############################ 配置部分 start ############################
    // 模块名称
    private static final String MODULE_NAME = "bill";
    // 作者
    private static final String AUTHOR = "zqq";
    // 生成的表名称
    private static final String TABLE_NAME = "yx_wx_user_bill";    // 主键数据库列名称
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/yshop-open-api/src/main/java");
        gc.setAuthor(AUTHOR);
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/yshop-open-api/src/main/resources/mapper/" + pc.getModuleName()
        ...
        focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/yshop-open-api/src/main/java/" + PROJECT_PACKAGE_PATH + "/modules/" + pc.getModuleName() + "/web/param/" + tableInfo.getEntityName() + "QueryParam" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/queryVo.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/yshop-open-api/src/main/java/" + PROJECT_PACKAGE_PATH + "/modules/" + pc.getModuleName() + "/web/vo/" + tableInfo.getEntityName() + "QueryVo" + StringPool.DOT_JAVA;
            }
        });
