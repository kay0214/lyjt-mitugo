  ...
  <div class="order-details">
      ...
      >
        ...
        <div class="rules">
          <div class="item">
            ...
            <div class="info">
              每日：<span class="time">{{ system_store.dayTime }}</span>
            </div>
          </div>
          <div class="item">
            <div class="rulesTitle acea-row row-middle">
    ...
    <div v-if="orderInfo.status != 0">
      ...
      <div class="wrapper" v-else>
        ...
        <div class="item acea-row row-between">
          <div>配送电话：</div>
          <div class="conter acea-row row-middle row-right">
            {{ orderInfo.deliveryId || "" }}<span class="copy">拨打</span>
          </div>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <template v-if="status.type == 1">
        <div
          class="bnt cancel"
          @click="$router.push({ path: '/order/refund/' + orderInfo.orderId })"
        >
          申请退款
        </div>
      </template>
      <template v-if="status.type == 2">
        <div
          class="bnt default"
          @click="
            $router.push({ path: '/order/logistics/' + orderInfo.orderId })
          "
        >
          查看物流
        </div>
      ...
      <template v-if="status.type == 6">
        <div
          ...
          @click="
            $router.push({ path: '/activity/group_rule/' + orderInfo.pinkId })
          "
        >
          查看拼团
        </div>
