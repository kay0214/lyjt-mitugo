...
public interface LogMapper extends CoreMapper<Log> {
    ...
    @Select("<script>select l.id,l.create_time as createTime,l.description, l.request_ip as requestIp,l.address,u.nickname,1.product_type,1.product_id from log l  " +
