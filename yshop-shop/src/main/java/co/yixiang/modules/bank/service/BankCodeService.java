...
/**
    ...
    */
    Map<String,Object> queryAll(BankCodeQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<BankCodeDto>
    */
    List<BankCode> queryAll(BankCodeQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<BankCodeDto> all, HttpServletResponse response) throws IOException;
}
