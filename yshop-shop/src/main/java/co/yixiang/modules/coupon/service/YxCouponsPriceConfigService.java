...
/**
    ...
    */
    Map<String,Object> queryAll(YxCouponsPriceConfigQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxCouponsPriceConfigDto>
    */
    List<YxCouponsPriceConfig> queryAll(YxCouponsPriceConfigQueryCriteria criteria);
