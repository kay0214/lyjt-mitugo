...
/**
    ...
    */
    Map<String,Object> queryAll(YxCouponsReplyQueryCriteria criteria, Pageable pageable);
    ...
    * @throws IOException /
    */
    void download(List<YxCouponsReplyDto> all, HttpServletResponse response) throws IOException;
}
