...
/**
    ...
    */
    Map<String,Object> queryAll(YxCouponOrderDetailQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxCouponOrderDetailDto>
    */
    List<YxCouponOrderDetail> queryAll(YxCouponOrderDetailQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxCouponOrderDetailDto> all, HttpServletResponse response) throws IOException;
}
