...
/**
    ...
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxCouponOrderUseDto>
    */
    List<YxCouponOrderUse> queryAll(YxCouponOrderUseQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxCouponOrderUseDto> all, HttpServletResponse response) throws IOException;
}
