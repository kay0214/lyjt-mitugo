...
/**
    ...
    */
    Map<String,Object> queryAll(YxNoticeQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxNoticeDto>
    */
    List<YxNotice> queryAll(YxNoticeQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxNoticeDto> all, HttpServletResponse response) throws IOException;
}
