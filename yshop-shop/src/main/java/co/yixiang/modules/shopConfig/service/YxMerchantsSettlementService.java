...
/**
    ...
    */
    Map<String,Object> queryAll(YxMerchantsSettlementQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxMerchantsSettlementDto>
    */
    List<YxMerchantsSettlement> queryAll(YxMerchantsSettlementQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxMerchantsSettlementDto> all, HttpServletResponse response) throws IOException;
     ...
     * @return
     */
    YxMerchantsSettlement selectById(Integer id);
}
