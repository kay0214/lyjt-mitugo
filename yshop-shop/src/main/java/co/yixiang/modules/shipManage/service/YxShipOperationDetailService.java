...
/**
    ...
    */
    Map<String,Object> queryAll(YxShipOperationDetailQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxShipOperationDetailDto>
    */
    List<YxShipOperationDetail> queryAll(YxShipOperationDetailQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxShipOperationDetailDto> all, HttpServletResponse response) throws IOException;
}
