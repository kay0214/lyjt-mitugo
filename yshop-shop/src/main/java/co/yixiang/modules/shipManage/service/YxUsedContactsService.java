...
/**
    ...
    */
    Map<String,Object> queryAll(YxUsedContactsQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxUsedContactsDto>
    */
    List<YxUsedContacts> queryAll(YxUsedContactsQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxUsedContactsDto> all, HttpServletResponse response) throws IOException;
}
