...
/**
    ...
    */
    Map<String,Object> queryAll(YxShipAppointDetailQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxShipAppointDetailDto>
    */
    List<YxShipAppointDetail> queryAll(YxShipAppointDetailQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxShipAppointDetailDto> all, HttpServletResponse response) throws IOException;
}
