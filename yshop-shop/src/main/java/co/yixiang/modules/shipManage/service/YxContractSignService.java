...
/**
    ...
    */
    Map<String,Object> queryAll(YxContractSignQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxContractSignDto>
    */
    List<YxContractSign> queryAll(YxContractSignQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxContractSignDto> all, HttpServletResponse response) throws IOException;
}
