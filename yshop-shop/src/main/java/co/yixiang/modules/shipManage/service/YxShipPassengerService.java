...
/**
    ...
    */
    Map<String,Object> queryAll(YxShipPassengerQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxShipPassengerDto>
    */
    List<YxShipPassenger> queryAll(YxShipPassengerQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxShipPassengerDto> all, HttpServletResponse response) throws IOException;
}
