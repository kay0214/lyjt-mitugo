...
/**
    ...
    */
    Map<String,Object> queryAll(YxContractTemplateQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YxContractTemplateDto>
    */
    List<YxContractTemplate> queryAll(YxContractTemplateQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YxContractTemplateDto> all, HttpServletResponse response) throws IOException;
}
