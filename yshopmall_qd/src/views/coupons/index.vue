      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="900px">
        ...
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="140px" v-if="crud.status.cu > 0">
          ...
          <el-form-item v-if="form.couponType === 1" prop="denomination" label="代金券面额">
            <el-input v-model="form.denomination" style="width: 650px;" maxlength="12" />
          </el-form-item>
          <el-form-item v-show="form.couponType === 2" prop="discount" :required="form.couponType === 2" label="折扣券折扣率">
            <el-input v-model="form.discount" style="width: 650px;" maxlength="4" />
          </el-form-item>
          <el-form-item v-if="form.couponType === 3" prop="threshold" label="使用门槛">
            <el-input v-model="form.threshold" style="width: 650px;" maxlength="12" />
          </el-form-item>
          <el-form-item v-if="form.couponType === 3" prop="discountAmount" label="优惠金额">
            <el-input v-model="form.discountAmount" style="width: 650px;" maxlength="12" />
          </el-form-item>
          <el-form-item label="卡券分类" prop="couponCategory">
            <el-select v-model="form.couponCategory" placeholder="请选择" style="width: 650px;">
              <el-option
          ...
          <el-form-item label="库存" prop="inventory">
            <el-input v-model="form.inventory" style="width: 650px;" maxlength="12" />
          </el-form-item>
          ...
          <!-- <el-form-item label="有效期始" prop="expireDateStart">
            <el-input v-model="form.expireDateStart" style="width: 650px;" />
          </el-form-item>
          <el-form-item label="有效期止" prop="expireDateEnd">
            <el-input v-model="form.expireDateEnd" style="width: 650px;" />
          </el-form-item> -->
          ...
          <!-- <el-form-item label="过期退" style="width: 650px;" v-if="false" >
          ...
          <el-form-item label="免预约 0:不支持 1支持" v-if="false">
            <el-input v-model="form.needOrder" style="width: 650px;" />
          </el-form-item>
          <el-form-item label="随时退 0:不支持 1支持" v-if="false">
            <el-input v-model="form.awaysRefund" style="width: 650px;" />
          </el-form-item> -->
          ...
          <!-- <el-form-item label="可用时间始" prop="availableTimeStart">
            <el-input v-model="form.availableTimeStart" style="width: 650px;" />
          </el-form-item>
          <el-form-item label="可用时间止" prop="availableTimeEnd">
            <el-input v-model="form.availableTimeEnd" style="width: 650px;" />
          </el-form-item> -->
          <el-form-item v-if="false" label="是否删除（0：未删除，1：已删除）" prop="delFlag">
            <el-input v-model="form.delFlag" style="width: 650px;" />
          </el-form-item>
          <el-form-item v-if="false" label="创建人 根据创建人关联店铺">
            <el-input v-model="form.createUserId" style="width: 650px;" />
          </el-form-item>
          <el-form-item v-if="false" label="修改人">
            <el-input v-model="form.updateUserId" style="width: 650px;" />
          </el-form-item>
          <el-form-item v-if="false" label="创建时间" prop="createTime">
            <el-input v-model="form.createTime" style="width: 650px;" />
          </el-form-item>
          <el-form-item v-if="false" label="更新时间" prop="updateTime">
            <el-input v-model="form.updateTime" style="width: 650px;" />
          </el-form-item>
          <el-form-item label="卡券简介" prop="couponInfo">
            <el-input type="textarea" v-model="form.couponInfo" style="width: 650px;" maxlength="88" />
          </el-form-item>
