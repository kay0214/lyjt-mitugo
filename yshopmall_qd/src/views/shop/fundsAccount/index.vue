    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="平台分佣总额">
            <el-input v-model="form.price" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="分红总积分">
            <el-input v-model="form.bonusPoint" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="拉新总积分">
            <el-input v-model="form.referencePoint" style="width: 370px;" />
          </el-form-item>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="columns.visible('price')" prop="price" label="平台分佣总额" />
        <el-table-column v-if="columns.visible('bonusPoint')" prop="bonusPoint" label="分红总积分" />
        <el-table-column v-if="columns.visible('referencePoint')" prop="referencePoint" label="拉新总积分" />
        ...
        <el-table-column v-permission="['admin','yxFundsAccount:edit','yxFundsAccount:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudYxFundsAccount from '@/api/yxFundsAccount'
...
export default {
  ...
  data() {
    return {
      ...
      permission: {
        add: ['admin', 'yxFundsAccount:add'],
        edit: ['admin', 'yxFundsAccount:edit'],
        del: ['admin', 'yxFundsAccount:del']
      },
      rules: {
        delFlag: [
