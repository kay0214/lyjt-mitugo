    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="用户角色：0->平台运营,1->合伙人,2->商户" prop="userRole">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="columns.visible('userRole')" prop="userRole" label="用户角色：0->平台运营,1->合伙人,2->商户" />
        ...
        <el-table-column v-permission="['admin','yxCustomerService:edit','yxCustomerService:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudYxCustomerService from '@/api/yxCustomerService'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '机器人客服', url: 'api/yxCustomerService', sort: 'id,desc', crudMethod: { ...crudYxCustomerService }})
const defaultForm = { id: null, question: null, sort: null, status: null, userRole: null, delFlag: null, createUserId: null, updateUserId: null, createTime: null, updateTime: null, answer: null }
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userRole: [
          { required: true, message: '用户角色：0->平台运营,1->合伙人,2->商户不能为空', trigger: 'blur' }
        ],
        delFlag: [
