  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','yxCommissionRate:edit','yxCommissionRate:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudYxCommissionRate from '@/api/yxCommissionRate'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '分佣配置', url: 'api/yxCommissionRate', sort: 'id,desc', crudMethod: { ...crudYxCommissionRate }})
const defaultForm = { id: null, fundsRate: null, shareRate: null, shareParentRate: null, parentRate: null, merRate: null, partnerRate: null, referenceRate: null, delFlag: null, createUserId: null, updateUserId: null, createTime: null, updateTime: null }
export default {
  ...
  data() {
    return {
      ...
      permission: {
        add: ['admin', 'yxCommissionRate:add'],
        edit: ['admin', 'yxCommissionRate:edit'],
        del: ['admin', 'yxCommissionRate:del']
      },
      rules: {
        delFlag: [
