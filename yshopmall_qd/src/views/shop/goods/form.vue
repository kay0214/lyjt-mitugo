<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="900px">
    <el-form ref="form" v-if="dialog" :model="form" :inline="false" :rules="rules" size="small" label-width="140px">
      <el-form-item label="商品分类" prop='storeCategory'>
        <treeselect v-model="form.storeCategoryId" :options="cates" style="width:650px" placeholder="选择商品分类" noOptionsText='暂无数据' noResultsText='无数据'/>
      </el-form-item>

      <el-form-item label="商品名称" prop='storeName'>
        <el-input v-model="form.storeName"  style="width:650px" maxlength="42" />
      </el-form-item>
      <!-- <el-form-item label="关键字" prop='keyword'>
        <el-input v-model="form.keyword" style="width: 500px;" />
      </el-form-item> -->
      <el-form-item label="商品单位" prop='unitName'>
        <el-input v-model="form.unitName"  style="width:650px" maxlength="3" />
      </el-form-item>
