      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="图片">
            <el-input v-model="form.noticeImage" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="内容">
            <el-input v-model="form.noticeContent" style="width: 370px;" />
          </el-form-item>
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '公告', url: 'api/yxNotice', sort: 'id,desc', crudMethod: { ...crudYxNotice }})
const defaultForm = { id: null, noticeImage: null, noticeContent: null, linkUrl: null, status: null, delFlag: null, createUserId: null, updateUserId: null, createTime: null, updateTime: null }
export default {
  name: 'YxNotice',
